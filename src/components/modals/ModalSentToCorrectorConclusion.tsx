...
const ModalSentToCorrectorConclusion: React.FC<Props> = ({ close, open, conclusionId }) => {
    ...
    const sendToCorrectorConclusion = () => {
        ...
        ConclusionsServices.changeConclusion(conclusionId, { status_id: 11 })
    ...
    return (
        <>
            <Portal close={close} open={open}>
                ...
                <p className='modal__ask'>{t("send_to_corrector_conclusion")}</p>
...
export default ModalSentToCorrectorConclusion