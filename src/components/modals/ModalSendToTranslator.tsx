...
const ModalSendToTranslator: React.FC<Props> = ({ close, open, conclusionId, conclusionData }) => {
    ...
    return (
        <>
            <Portal close={close} open={open}>
                ...
                <p className='modal__ask'>{t("confirm_send_to_translator")}</p>
...
export default ModalSendToTranslator